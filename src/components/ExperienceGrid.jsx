            ...
            <div className="relative aspect-[4/5]">
              ...
              <div className="relative z-20 h-full">
                {experience.discount > 0 && (
                    <div
                        className="absolute top-2 left-2 bg-red-600 text-white px-2 py-0.5 rounded-full text-xs font-bold shadow-lg">
                      {experience.discount}% OFF
                    </div>
                )}
                {experience.category && (
                    <div
                        className="absolute top-2 right-2 bg-black bg-opacity-50 backdrop-blur-sm text-white px-2 py-0.5 rounded-full text-xs shadow-lg">
                      {experience.category}
                    </div>
                )}
