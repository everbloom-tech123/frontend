...
const Header = () => {
  ...
  return (
      <div className="relative w-full h-screen bg-gradient-to-br from-red-50 via-white to-gray-50">
        <div className="container mx-auto h-full px-8 py-24">
          <div className="relative flex items-center justify-between h-full">
            {/* Left Content Section */}
            <div className="w-1/3 pr-12 space-y-10">
              <motion.div
              ...
              >
                <h1 className="text-6xl font-black leading-tight text-gray-800">
                  ...
                  <br />
                  <span className="text-4xl italic font-semibold mt-2 block">
                  in the world!
                </span>
                </h1>
            ...
            <div className="w-2/3 h-full pl-12">
              <div className="relative flex space-x-3 h-[90%]">
                {/* Navigation Buttons */}
                <button
                    onClick={handlePrev}
                    className="absolute -left-6 top-1/2 -translate-y-1/2 z-20 bg-red-500 p-4 rounded-xl shadow-lg hover:shadow-xl transition-all hover:bg-red-600 border border-red-400 transform hover:-translate-y-0.5"
                >
                  <ChevronLeft className="w-6 h-6 text-white" />
                </button>
                <button
                    onClick={handleNext}
                    className="absolute -right-6 top-1/2 -translate-y-1/2 z-20 bg-white p-4 rounded-xl shadow-lg hover:shadow-xl transition-all hover:bg-gray-50 border border-gray-200 transform hover:-translate-y-0.5"
                >
                  <ChevronRight className="w-6 h-6 text-red-500" />
                </button>

                {/* Main Image */}
                <div className="w-2/3 h-full rounded-2xl overflow-hidden shadow-2xl relative">
                ...
                {/* Side Images */}
                <div className="w-1/3 h-full space-y-8">
                  {[1, 2].map((offset) => (
                      <motion.div
