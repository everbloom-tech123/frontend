          ...
          <div className="flex space-x-4">
            ...
            <div className="w-1/2">
              <motion.img
                ...
                className="w-full h-96 object-cover rounded-lg hover:scale-105 transition-transform duration-700"
                whileHover={{ scale: 1.05 }}
              />
            </div>
            ...
            <div className="w-1/4">
              <div className="h-full">
                <motion.img
                  ...
                  className="w-full h-80 object-cover rounded-lg hover:scale-105 transition-transform duration-700"
                  whileHover={{ scale: 1.05 }}
                />
