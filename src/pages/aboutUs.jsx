...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-red-400 to-red-500 text-white py-32">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto font-light">
            Crafting extraordinary moments through meticulously curated experiences that reveal the authentic soul of Sri Lanka
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {stats.map((stat, index) => (
            <div key={index} className="bg-white rounded-lg shadow-lg p-8 text-center hover:shadow-xl transition-shadow duration-300 border-b-2 border-red-400">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Founded in 2023, Ceylon Bucket emerged from a profound desire to share Sri Lanka's extraordinary heritage with discerning travelers. We believe that truly remarkable journeys transcend mere sightseeing—they're transformative experiences that forge deep connections with our island's rich culture, warm-hearted people, and timeless traditions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
          {experiences.map((exp, index) => (
            <div key={index} className="bg-white rounded-lg p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 group hover:bg-red-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center p-8 rounded-lg bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">We carefully curate each experience to reveal the true essence of Sri Lanka, from ancient traditions to modern cultural expressions.</p>
            </div>
            <div className="text-center p-8 rounded-lg bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">Sustainable Tourism</h3>
              <p className="text-gray-600 leading-relaxed">Every adventure is designed with environmental consciousness at its core, supporting local conservation efforts and communities.</p>
            </div>
            <div className="text-center p-8 rounded-lg bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">Excellence in Service</h3>
              <p className="text-gray-600 leading-relaxed">Our dedication to exceptional service means personalized attention, expert guidance, and seamless logistics throughout your journey.</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {team.map((member, index) => (
              <div key={index} className="text-center group">
                <div className="w-40 h-40 mx-auto mb-6 rounded-full overflow-hidden ring-4 ring-red-200 group-hover:ring-red-300 transition-all duration-300">
                  <img
      ...
      <div className="bg-gradient-to-r from-red-400 to-red-500 text-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-12 max-w-2xl mx-auto leading-relaxed">
            Let us craft an extraordinary journey that captures the essence of Sri Lanka's timeless beauty and rich cultural heritage.
          </p>
          <button className="bg-white text-red-600 px-12 py-4 rounded-lg font-semibold hover:bg-gray-50 transition-colors text-lg shadow-lg hover:shadow-xl">
            Start Planning
          </button>
        </div>
      </div>
